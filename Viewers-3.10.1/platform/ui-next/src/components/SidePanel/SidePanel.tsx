...
const baseClasses = 'bg-white border-black justify-start box-content flex flex-col';
...
const getTabClassNames = (
  ...
  classnames('h-[28px] mb-[2px] cursor-pointer text-white bg-[#008959]', {
...
const SidePanel = ({
  ...
  const getOneTabComponent = () => {
    return (
      <div
        className={classnames(
          'flex grow cursor-pointer select-none justify-center self-center text-[13px] text-black'
        )}
  ...
  const getOpenStateComponent = () => {
    return (
      <>
        <div className="bg-[#008959] flex h-[40px] flex-shrink-0 select-none rounded-t p-2">
